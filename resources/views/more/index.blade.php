 ...
 @section('content')
     ...
     @if ($mid == '0')
         <h2 class="pb-4 text-3xl font-bold text-gray-700 ">
          <div class=" my-1/12  text-center text-red-600 uppercase font-mono">   No More Data Found Found. <br></div>
             <div class=" text-blue-900 w-fill m-auto   border-gray-700  ">

                 <a class="no-underline mx-3.5  my-3.5  hover:bg-indigo-300 hover:text-cool-gray-900 rounded-3xl py-1 px-4"
                     href="/">Home</a>
